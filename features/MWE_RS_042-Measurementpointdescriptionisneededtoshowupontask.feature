Feature: MWE_RS_042 - Measurement point description is needed to show up on task

  Scenario Outline: Measurement point description is needed to show up on task
