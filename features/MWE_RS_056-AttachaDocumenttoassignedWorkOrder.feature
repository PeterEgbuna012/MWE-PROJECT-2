Feature: MWE_RS_056 - Attach a Document to assigned Work Order and verify in Files tab

  Scenario Outline: Attach a Document to assigned Work Order and verify in Files tab
    ...
    Then I take a screenshot
    Then I click on "TEAM VIEW FILES ICON" button
    Then I wait for page to load
    Then I take a screenshot
    Then I click on "CLOSE FILE" button
    Then I wait for page to load
    Then I take a screenshot
