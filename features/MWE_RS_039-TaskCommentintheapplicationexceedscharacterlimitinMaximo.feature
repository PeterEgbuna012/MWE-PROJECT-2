Feature: MWE_RS_039 - Task Comment in the application exceeds character limit in Maximo

  Scenario Outline: Task Comment in the application exceeds character limit in Maximo
   ...
   # Then "10" page appears
    And I set "comments" value field to "Where the Sun Lingers The morning spills gold across the fields, dew trembling like laughter held too long. Soft winds hum through the open sky, carrying secrets of salt and song. Children chase echoes of kites and dreams, bare feet painting dust on the road. Lemon light drift. Mwe task comment test."
