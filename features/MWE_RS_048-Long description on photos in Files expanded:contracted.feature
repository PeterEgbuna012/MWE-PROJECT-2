Feature: MWE_RS_048 - Remove Maximo Long Description from storage in its original format on BMP

Scenario Outline: Remove Maximo Long Description from storage in its original format on BMP
