...
class NSUUID extends BaseArchiveHandler {
    ...
    decodeArchive(archive) {
        return (0, uuid_1.stringify)(archive.decode('NS.uuidbytes'));
    }
    encodeArchive(obj, archive) {
        archive._archiveObj['NS.uuidbytes'] = Buffer.from((0, uuid_1.parse)(obj._data).buffer);
    }
}
...
XCActivityRecord._keys = ['activityType', 'attachments', 'finish', 'start', 'title', 'uuid'];
/**
...
function updateNSKeyedArchiveClass(name, subClass) {
    ...
    if (!lodash_1.default.isFunction(subClass.prototype?.decodeArchive) && !lodash_1.default.isFunction(subClass.prototype?.encodeArchive)) {
