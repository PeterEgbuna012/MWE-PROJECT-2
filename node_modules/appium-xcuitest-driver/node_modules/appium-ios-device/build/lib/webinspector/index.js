...
class WebInspectorService extends base_service_1.BaseServiceSocket {
    ...
    constructor(opts = {}) {
        ...
        if (lodash_1.default.isFunction(socketClient.setMaxSendFragment) && lodash_1.default.isNumber(socketChunkSize) && socketChunkSize > 0) {
        ...
        if (!isSimulator && lodash_1.default.isNumber(majorOsVersion) && majorOsVersion < PARTIAL_MESSAGE_SUPPORT_DEPRECATION_VERSION) {
